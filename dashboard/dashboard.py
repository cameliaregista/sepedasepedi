...
st.sidebar.markdown(
    "**• Email: [cameliaregista05@gmail.com](cameliaregista05@gmail.com)**")
st.sidebar.markdown(
    "**• ID Dicoding: [cameliaregista](https://www.dicoding.com/users/cameliaregista/)**")
st.sidebar.markdown(
    "**• LinkedIn: [camelia regista](https://www.linkedin.com/in/cameliaregista)**")



st.sidebar.title("Dataset Bike Share Analysis")
# Show the dataset
